...
public class BeanMapper {
	...
	public static <T> List<T> mapList(Collection sourceList, Class<T> destinationClass) {
		return mapList(sourceList, destinationClass, null);
	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static <T> List<T> mapList(Collection sourceList, Class<T> destinationClass, ICustomerMapper<T> customerMapper) {
		List<T> destinationList = Lists.newArrayList();
		for (Object sourceObject : sourceList) {
			T destinationObject = dozer.map(sourceObject, destinationClass);
			if (customerMapper != null) {
				try {
					customerMapper.render(sourceObject, destinationObject);
				} catch (Exception e) { // 这里包容异常....
					e.printStackTrace();
				}
			}
	...
	public static interface ICustomerMapper<Dest> {
		void render(Object source, Dest dest);
	}
